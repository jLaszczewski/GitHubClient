...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ios-extensions/ios_extensions.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ios-extensions-rx/ios_extensions_rx.framework"
fi
